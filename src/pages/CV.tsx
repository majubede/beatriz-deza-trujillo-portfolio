...
const CV: React.FC = () => {
  ...
  const publications: CVItem[] = [
    { year: '2026', title: language === 'es' ? 'Analog Forever Magazine — selección "20 Experimental Photographers"' : 'Analog Forever Magazine — "20 Experimental Photographers" selection' },
    { year: '2026', title: language === 'es' ? 'Desphotomag — especial editorial (3 páginas)' : 'Desphotomag — editorial special (3 pages)' },
    ...
    { year: '2024', title: 'Cadaver Exquisito Fanzine num16 — 49 retratos alternativos y una canción desesperada' },
