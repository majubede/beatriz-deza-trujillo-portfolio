            ...
            <div key={sub.slug} className="border-b border-border pb-4">
              ...
              {expandedSubseries === sub.slug && sub.images.length > 0 && (
                <div className="mt-6 mb-8 fade-in">
                  ...
                  {sub.slug === 'boys-dont-cry' && (
                    <p className="body-curatorial mb-6">{t('series.territorios.boysdontcry.text')}</p>
                  )}
                  {sub.slug === 'geografias-fugaces' && (
                    <p className="body-curatorial mb-6">{t('series.territorios.geografias.text')}</p>
                  )}
                  {sub.slug === 'pool-story' && (
                    <p className="body-curatorial mb-6">{t('series.territorios.poolstory.text')}</p>
                  )}
                  {sub.slug === 'barbie-y-sus-amigos' && (
                    <p className="body-curatorial mb-6">{t('series.territorios.barbie.text')}</p>
                  )}
                  {sub.slug === 'dia-en-titulcia' && (
                    <p className="body-curatorial mb-6">{t('series.territorios.titulcia.text')}</p>
                  )}
